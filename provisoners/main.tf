...
resource "aws_instance" "server" {
  ...
  connection {
    ...
    private_key = file("C:/Users/Admin/.ssh/id_ed25519")  #private key path
    host        = self.public_ip
  }
 ...
 provisioner "local-exec" {
  ...
  provisioner "file" {
    source      = "C:/Users/Admin/Desktop/devops nar/file10.txt"  # Replace with the path to your local file
